...
void BitcoinGUI::createActions()
{
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Graviocoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Graviocoin network", "", count));
}
...
{
    QString strTitle = tr("Graviocoin"); // default title
